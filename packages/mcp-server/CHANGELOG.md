...
- Fixed build output to include missing transport files (`stdio.js` and `http.js`)
- Package now correctly includes all compiled JavaScript files needed for `npx` execution
